...
/*
 * This is a Handler structure for GPIO pin
 */
typedef struct
{
	//poiter to hold the base address of the GPIO peripheral
	GPIO_RegDef_t *pGPIOx; // This hold base address pf the GPIO port to which the pin belongs
...
/*
 * @GPIO_PIN_SPEED
 * GPIO pin possible output speed mode
*/
